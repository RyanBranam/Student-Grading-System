...
ReportCard::ReportCard(const std::string& studentName, double average,
    ...
    : studentName(studentName), average(average), finalGrade(finalGrade),
      behavior(behavior), comments(comments) {}
...
// Getters
std::string ReportCard::getStudentName() const { return studentName; }
double ReportCard::getAverage() const { return average; }
std::string ReportCard::getFinalGrade() const { return finalGrade; }
std::string ReportCard::getBehavior() const { return behavior; }
std::string ReportCard::getComments() const { return comments; }
